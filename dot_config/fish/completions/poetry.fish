...
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a cache
...
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a check -d 'Validates the content of the pyproject.toml file and its consistency with the poetry.lock file.'
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a config -d 'Manages configuration settings.'
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a debug
...
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a env
...
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a self
...
complete -c poetry -f -n '__fish_poetry_abe06ec59f74dbfe_complete_no_subcommand' -a source
